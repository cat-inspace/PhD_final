...
The optimum parameters for processing the model cheese mass are chosen from the process and compositional analysis preceding this work in @Roeck2010, and were a shear-rate of 200/s of the stirrer, which is ~16 min^-1 stirring speed. The temperature was chosen to be 90 C, the total protein concentration is set to be 15% and only derived from casein, the pH for the educt was set to 5.88.
