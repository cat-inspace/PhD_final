...
```
comparison of fat-type



```{r, echo=FALSE, out.width="75%", fig.cap="Overview of Rheological Profile of samples made from sodium caseinate with either the mixture of emulsifying salts used herein (green), HCl (blue) or Citric Acid (red) for pH adjustmment (for more details see down below)"}
knitr::include_graphics("plots/1.3_sodium.rheo.sum.jpeg")
```
For more detail see Figure below.
